...
2. Use [.env.template](.env.template) as the configuration contract.
3. Load only the references needed for the current source and target:
...
- Treat OpenAPI and database schemas as source contracts.
